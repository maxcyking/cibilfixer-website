        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="px-6 py-8 sm:px-10 sm:py-12">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                Contact us at <a href="mailto:privacy@cibilfixer.com" className="text-blue-600 hover:text-blue-800">privacy@cibilfixer.com</a> with your request. We will respond within 30 days and verify your identity before processing any requests.
              </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <p className="text-gray-600 mb-2">
                      <strong>Email:</strong> <a href="mailto:privacy@cibilfixer.com" className="text-blue-600 hover:text-blue-800">privacy@cibilfixer.com</a>
                    </p>
                    <p className="text-gray-600 mb-2">
                      <strong>Support Email:</strong> <a href="mailto:support@cibilfixer.com" className="text-blue-600 hover:text-blue-800">support@cibilfixer.com</a>
                    </p>
                    <p className="text-gray-600 mb-2">
                      <strong>Phone:</strong> <a href="tel:+919876543210" className="text-blue-600 hover:text-blue-800">+91-9876543210</a>
                    </p>
                    <p className="text-gray-600 mb-4">
                      <strong>WhatsApp:</strong> <a href="https://wa.me/919876543210" className="text-blue-600 hover:text-blue-800">+91-9876543210</a>
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      CibilFixer Technologies Pvt. Ltd.<br />
                      Office No. 304, 3rd Floor<br />
                      Cyber Gateway Building<br />
                ...
                <div className="mt-6 pt-4 border-t border-blue-200">
                  <h3 className="text-lg font-medium text-gray-700 mb-2">Grievance Officer</h3>
                  <p className="text-gray-600 text-sm">
                    <strong>Name:</strong> Rajesh Kumar Sharma<br />
                    <strong>Email:</strong> <a href="mailto:grievance@cibilfixer.com" className="text-blue-600 hover:text-blue-800">grievance@cibilfixer.com</a><br />
                    <strong>Phone:</strong> <a href="tel:+919876543211" className="text-blue-600 hover:text-blue-800">+91-9876543211</a>
                  </p>
                </div>
                
                <div className="mt-4 pt-4 border-t border-blue-200">
                  <h3 className="text-lg font-medium text-gray-700 mb-2">Data Protection Officer</h3>
                  <p className="text-gray-600 text-sm">
                    <strong>Name:</strong> Priya Mehta<br />
                    <strong>Email:</strong> <a href="mailto:dpo@cibilfixer.com" className="text-blue-600 hover:text-blue-800">dpo@cibilfixer.com</a><br />
                    <strong>Phone:</strong> <a href="tel:+919876543212" className="text-blue-600 hover:text-blue-800">+91-9876543212</a>
                  </p>
                </div>
              </div>
