        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              <div className="p-8">
                <div className="text-center mb-6">
                  <Smartphone className="h-16 w-16 mx-auto mb-4 text-primary-600" />
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Android</h3>
                  <p className="text-gray-600 mb-4">Partner application for Android devices with full functionality</p>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              <div className="p-8">
                <div className="text-center mb-6">
                  <Apple className="h-16 w-16 mx-auto mb-4 text-primary-600" />
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">iOS</h3>
                  <p className="text-gray-600 mb-4">Partner application for iPhone and iPad devices</p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">App Details</h4>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li><strong>Requirements:</strong> iOS 12.0 or higher</li>
                    <li><strong>Last Updated:</strong> Coming Soon</li>
                  </ul>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              <div className="p-8">
                <div className="text-center mb-6">
                  <Monitor className="h-16 w-16 mx-auto mb-4 text-primary-600" />
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Windows PC</h3>
                  <p className="text-gray-600 mb-4">Desktop application for Windows computers</p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">App Details</h4>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li><strong>Requirements:</strong> Windows 10 or higher</li>
                    <li><strong>Last Updated:</strong> Coming Soon</li>
                  </ul>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              <div className="p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 mb-4">Desktop application for Mac computers</p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">App Details</h4>
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li><strong>Requirements:</strong> macOS 10.15 or higher</li>
                    <li><strong>Last Updated:</strong> Coming Soon</li>
                  </ul>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
                <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
                  ...
                  <div className="flex space-x-3">
                    <a href="https://www.instagram.com/cibilfixer/" target="_blank" rel="noopener noreferrer" title="Follow us on Instagram" className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center transition-colors">
                    ...
                    <a href="https://www.facebook.com/Cibilfixer/" target="_blank" rel="noopener noreferrer" title="Follow us on Facebook" className="w-8 h-8 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center transition-colors">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                      </svg>
                    </a>
                    <a href="https://www.youtube.com/@cibilfixer" target="_blank" rel="noopener noreferrer" title="Subscribe to our YouTube channel" className="w-8 h-8 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center transition-colors">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                      </svg>
                    </a>
                    <a href="https://wa.me/919414118156" target="_blank" rel="noopener noreferrer" title="Contact us on WhatsApp" className="w-8 h-8 bg-green-600 hover:bg-green-700 rounded-full flex items-center justify-center transition-colors">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
