            ...
            {packages.map((pkg, index) => {
              ...
              return (
                <div key={index} className={`bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden ${
                  pkg.recommended ? 'ring-2 ring-primary-500 relative' : ''
                }`}>
                  {pkg.recommended && (
                  ...
                  <div className="p-5">
                    ...
                    <Link 
                      ...
                      className={`w-full block text-center py-2.5 px-4 rounded-lg text-sm font-semibold transition-colors duration-200 ${
                        pkg.recommended 
